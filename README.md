...
* [UE Blueprint Graph Viewer](https://github.com/glgen/UEBlueprintGraphViewer) - Written by **glgen**
    - A tool for viewing compiled blueprint code of Unreal Engine 4-5 games
    - 4.25 and later versions are supported
...
* **[CU]** [jmap dumper](https://github.com/trumank/jmap) - Written by **trumank**
    - A dumper that can generate `.jmap` files using just a minidump or a running process of a game 
    - `.jmap` format can be used with Suzie, FModel and other tools that adopt the format, but can also generate legacy `.usmap` format
* **[CU]** [Dumper-7](https://github.com/Encryqed/Dumper-7) - Written by **Fischsalat & Encryqed**
    - SDK Generator for all Unreal Engine games. 
    - Supports all of UE4 and UE5
* [IDA Exec Functions Importer](https://github.com/Fischsalat/IDAExecFunctionsImporter) - Written by **the dumper 7 team** 
    - An IDA plugin for importing Unreal Engine symbols and types from the `CppSDK` and `IDAMappings` output generated by Dumper-7
* [UE4 Game Project Generator](https://github.com/Archengius/UE4GameProjectGenerator) - Written by **Archengius**
...
* [Uasset Localize](https://github.com/rm-NoobInCoding/UassetLocalize) - Written by **NoobInCoding**
...
* [oatmealf](https://github.com/1D-gh/oatmealf) - Written by **Woody**
    - A tool which compares the shader parameter layouts between a game and an unreal editor and generates engine source updates for mismatched layouts
    - Useful for cooked editor modkits that want to load in compiled shaders but requires engine changes for matching to game's shader parameter layouts
    - Provides automation for the manual workflow that is written up [here](https://github.com/1D-gh/oatmealf/blob/main/docs%2Fsubnautica2-manual-workflow.md)
...
* [Visual Studio Uninstaller](https://github.com/microsoft/VisualStudioUninstaller)
    - This executable is designed to clean up and delete Preview, RC and final releases of Visual Studio 2013 and Visual Studio 2015.
...
* [Get Oodle lib](https://github.com/ymelois/get-oodle-lib) - Written by **ymelois**
...
* [Subnautica 2 Modding](https://discord.gg/CtFur77MJP)
...
* [Subnautica 2](https://github.com/Subnautica2Modding/Subnautica2-Project)